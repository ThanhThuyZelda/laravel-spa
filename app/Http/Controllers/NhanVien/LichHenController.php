...
class LichHenController extends Controller
{
    ...
    public function index()
    {
        ...
        ->paginate(5);
        return view('nhanvien.lichhen.index', compact('data'));
    }
    ...
    public function create()
    {
        ...
        return view('nhanvien.lichhen.create', compact('service'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $booking->save();
        return redirect('nhanvien/lichhen')->with('success', 'Đặt lịch thành công!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('nhanvien.lichhen.edit', compact('booking','service'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('nhanvien/lichhen')->with('success', 'Câp nhật thành công!');
    }
    ...
    public function destroy($id)
    {
        $booking = Booking::find($id);
        $booking->delete();
        return redirect('nhanvien/lichhen')->with('success', 'Đã xóa thành công!');
    }
}
