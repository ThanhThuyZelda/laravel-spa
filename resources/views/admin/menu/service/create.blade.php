...
@section('content')
        <div class="container" style="margin-top:20px">
                <div class="row">
                        <div class="col-md-12">
                                <h2>Thêm dịch vụ mới</h2><hr>
                                <form action="{{ url('admin/menu/service') }}" method="POST" >
                                        @csrf
                                        ...
                                        <div class="form-group">
                                                ...
                                                class="form-control form-control-user" value="{{ old('DV_name') }}"> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            class="form-control form-control-user"  value="{{ old('Dv_gia') }}" > 
                                            <span class="text-danger small">@error('price') {{ $message }} @enderror</span>
                                        </div>
                                        <div class="form-group">
                                                <label>Mô tả</label>
                                                <textarea name="DV_mota"  placeholder="Enter Conent...." class="form-control form-control-user"> </textarea>
                                                <span class="text-danger small">@error('content') {{ $message }} @enderror</span>
                                        </div>
                                        <div class="form-group">
                                                <label>Nội dung</label>
                                                <textarea name="DV_nd" id="DV_nd" placeholder="Enter Conent...." class="form-control form-control-user"> </textarea>
                                                <span class="text-danger small">@error('content') {{ $message }} @enderror</span>
                                        </div>
                                        <div class="md-3">
