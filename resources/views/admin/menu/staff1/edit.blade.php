...
@section('content')
        <div class="container" style="margin-top:20px">
                <div class="row">
                        <div class="col-md-12">
                                <h2>Cập nhật nhân viên</h2><hr>
                                <form action="{{  url('admin/menu/staff1/'.$staff->NV_id ) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        @endif
                                        <input type="hidden" name="NV_id" value="{{ $staff->NV_id }}">
                                        <div class="form-group">
                                                <label id="room_name">Tên nhân viên</label>
                                                <input type="text" name="fullname" id="fullname" placeholder="Enter Fullname ...." 
                                                class="form-control form-control-user" value="{{ $staff->fullname }}"> 
                                                <span class="text-danger small">@error('fullname') {{ $message }} @enderror</span>
                                        </div>
                                        <div class="form-group">
                                            <label id="avatar">Avatar</label>
                                            <input type="file" name="avatar" id="avatar" class="form-control form-control-user" value="{{ $staff->avatar }}"  > 
                                            {{-- <img src="{{ $staff->avatar }}" width="50px" height="70px"> --}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            class="form-control form-control-user"  value="{{ $staff->email }}" > 
                                            <span class="text-danger small">@error('email') {{ $message }} @enderror</span>
                                        </div>
                                        <div class="form-group">
                                                <label id="password">Password</label>
                                                <input type="password" name="password" id="password" placeholder="Enter Password...."
                                                 class="form-control form-control-user" value="{{ $staff->password }}" > 
                                        ...
                                        <div class="form-group">
                                                ...
                                                class="form-control form-control-user"  value="{{ $staff->phone}}"> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="room_id" class="form-control">
                                                ...
                                                @foreach($room as $item)
                                                        ...
                                                        <option value="{{ $item->room_id }}" {{ $item->room_id == $staff->room_id ? 'selected' : '' }}>{{ $item->room_name }}</option>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <select name="CV_id" class="form-control">
                                                    ...
                                                    @foreach($position as $item)
                                                            <option value="{{ $item->CV_id}}" {{ $item->CV_id == $staff->CV_id ? 'selected' : '' }}>{{ $item->CV_name }}</option>
                                                    @endforeach
                                                </select>
                                                <span class="text-danger small">@error('room_name') {{ $message }} @enderror</span>
                                            </div>
                                        ...
                                        <div class="md-3">
                                                ...
                                                <a href="{{ url('admin/menu/staff1') }}" class="btn btn-danger">Back</a>     
                                        </div>        
                                <br>      
                                </form>
