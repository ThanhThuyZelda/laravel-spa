       ...
       <div class="row">
        <div class="col-md-12">
            ...
            <div style="margin: 20px; float:right; margin-right: 80px;">
                <a href="{{ url('nhanvien/lichhen/create') }}" class="btn btn-success">Add New</a>
            </div>
                    ...
                    @if(!empty($data) && $data->count())
                        @foreach ($data as $booking)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ url('nhanvien/lichhen/'.$booking->DL_id) }}" method="POST">
                                        
                                        <a href="{{ url('nhanvien/lichhen/' .$booking->DL_id. '/edit') }}" class="btn btn-primary">Update</a>
